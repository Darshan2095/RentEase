...
import { Bell, Search, Command, ChevronDown, Sparkles, Settings, LogOut, User } from "lucide-react";
      ...
      <div className="flex items-center gap-3.5">
        ...
        <DropdownMenu>
            ...
            <button className="flex items-center gap-2.5 p-1 rounded-xl hover:bg-slate-50 border border-transparent hover:border-slate-100 transition-all focus:outline-none group">
              <div className="relative">
                <Avatar className="h-8 w-8 rounded-lg border border-slate-200 shadow-sm transition-transform group-hover:scale-[1.02]">
                  <AvatarImage src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=100&q=80" alt="User Profile" />
          ...
          <DropdownMenuContent align="end" className="w-56 rounded-xl p-1 shadow-lg border-slate-100 mt-1">
            ...
            <DropdownMenuItem className="rounded-lg text-[13px] text-slate-600 font-medium py-2 focus:bg-slate-50 cursor-pointer">
            ...
            <DropdownMenuSeparator className="bg-slate-50" />
            <DropdownMenuItem className="rounded-lg text-[13px] font-semibold text-rose-600 py-2 focus:bg-rose-50 focus:text-rose-700 cursor-pointer">
